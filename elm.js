...
var $author$project$Main$UbahJumlahHarta = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$showConfig = function (config) {
	var sh = function (_v0) {
		var p = _v0.a;
		var j = _v0.b;
		return '(' + ($author$project$Main$showPewaris(p) + (' : ' + ($elm$core$String$fromInt(j) + ')')));
	};
	return A2(
		$elm$core$String$join,
		', ',
		A2($elm$core$List$map, sh, config));
};
...
var $author$project$Main$showHarta = A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$placeholder('Masukkan jumlah harta'),
						...
						A2(
							...
							A2(
								...
								$author$project$Main$UbahJumlahHarta)))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$p,
